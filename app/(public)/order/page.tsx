...
/* =====================================================================
   ...
   Custom layout (no SiteHeader, no SiteFooter):
     ...
     - .of-main: 1fr 360px grid â†’ form card + sidebar
   ...
   The 4-step progress (Step 01 What you need â†’ Step 04 Review) is owned
...
export const metadata: Metadata = {
  ...
  description:
    "Commission custom D&D character art from $60. Fill out our brief — Hector G. will hand-paint your character. No AI, no tracing. 2-week turnaround typical.",
