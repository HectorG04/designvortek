...
/* =====================================================================
   /guides/[genre] — long-form genre guide (a.k.a. "pillar" content).

   Renamed from /pillars/[genre] in May 2026 — "pillars" was internal
   SEO jargon. "Guides" matches what visitors see and search for.
   /pillars/[genre] still resolves via the 308 redirect at the old route.
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `/guides/${genreSlug}` },
    openGraph: {
      type: 'article',
      title: pillar.title,
      description,
...
export default async function GuidePage({ params }: PageProps) {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': `${SITE_URL}/guides/${genreSlug}` },
    about: genre.label,
  }
