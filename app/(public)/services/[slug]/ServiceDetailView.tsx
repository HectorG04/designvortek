...
export const SERVICES = {
  'character-art': {
    ...
    metaDescription: 'Painterly D&D character portraits from $180. 7–14 day turnaround, 4K delivery, 2 revisions included. Tieflings, half-elves, every species welcome.',
    startingPrice: '$180+',
    ...
    faq: [
      ...
      { q: 'Can I commission a copyrighted character?', a: 'For personal use only (your private collection, your character sheet), we’ll usually do fan art. For commercial use of someone else’s IP, we’d need written permission from the rights holder.' },
    ],
  },
  'vtt-tokens': {
    slug: 'vtt-tokens',
    ...
    metaDescription: 'VTT tokens for Roll20 and Foundry from $80. 512 + 1024px transparent PNG, decorative borders, bulk discounts for 4+ tokens.',
    startingPrice: '$80+',
    turnaround: '3–7 days',
    ...
    faq: [
      ...
      { q: 'Can you match an existing portrait?', a: 'Absolutely. If you already have a portrait — from us or elsewhere — we can build a matching token from it. Add the “matching VTT token” add-on at checkout.' },
  ...
  'party-portraits': {
    ...
    metaDescription: 'Hand-painted party portraits from $400. Up to 8 figures in matching style, scene backgrounds, print-ready files. D&D groups, weddings, and gifts.',
    startingPrice: '$400+',
  ...
  'npc-packs': {
    ...
    metaDescription: 'NPC pack illustrations from $600. 5+ portraits in matching style, VTT tokens included, schedule-friendly delivery for D&D campaigns.',
    startingPrice: '$600+',
  ...
  'custom-projects': {
    ...
    metaDescription: 'Custom illustration commissions for book covers, indie games, merch, and concept art. Bespoke quotes, commercial licensing, retainer arrangements.',
    startingPrice: 'Quote',
    turnaround: 'By scope',
    resolution: 'By scope',
    delivered: '30+',
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-ink-500 leading-[1.65] mt-5 max-w-[55ch]">
                  {data.lede}
                </p>
                    ...
                    >
                      ...
                      <AnimatePresence initial={false}>
                        {isOpen && (
                          ...
                          >
                            <p className="px-6 pb-5 text-ink-700 leading-[1.7] max-w-[64ch]">
                              {item.a}
                            </p>
                          </motion.div>
                        )}
